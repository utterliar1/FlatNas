...
export function createDefaultWidgetList(isLoggedIn: boolean): WidgetConfig[] {
  const base: WidgetConfig[] = [
    { id: "w1", type: "clock", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    { id: "w2", type: "weather", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    { id: "w3", type: "calendar", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    ...
    { id: "memo", type: "memo", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    { id: "todo", type: "todo", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    {
      id: "calculator",
      type: "calculator",
      enable: true,
    ...
    { id: "ip", type: "ip", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    { id: "hot", type: "hot", enable: true, colSpan: 1, rowSpan: 1, w: 1, h: 1, isPublic: true },
    { id: "player", type: "player", enable: true, colSpan: 2, rowSpan: 1, w: 2, h: 1, isPublic: true },
    {
      id: "status-monitor",
      type: "status-monitor",
      enable: false,
